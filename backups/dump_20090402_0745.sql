...
INSERT INTO `groups` VALUES (1,0,'user','users','Пользователи'),(3,0,'admin','administartors','Администраторы');
...
INSERT INTO `topics` VALUES (9,0,0,11,'aboutme','Обо мне','',0,12,1,1,1,'','article',10),(7,9,3,10,'portfolio','Портфолио','',0,0,1,1,1,'','article',20),(11,7,8,9,'photos','Фотографии работ','',0,0,1,1,1,'','gallery',20),(12,7,6,7,'performances','Перформансы','',0,0,1,1,1,'','article',20),(13,7,4,5,'masterclasses','Мастер-классы','',0,0,1,1,1,'','article',20),(23,9,1,2,'articles','Статьи','',0,0,1,1,496,'','article',20),(22,0,12,13,'news','Новости','',0,0,1,1,1,'','article',20);
...
INSERT INTO `users` VALUES (1,'Администратор','milezv@yandex.ru','2009-02-20 10:16:43','root','827ccb0eea8a706c4c34a16891f84e7b','superuser',3,'inactive','0000-00-00 00:00:00',0,'male'),(2,'Настя','vostorg@tut.by','2009-03-31 00:16:38','nastassya','5f4dcc3b5aa765d61d8327deb882cf99','admin',3,'','0000-00-00 00:00:00',0,'female');
...
-- Dump completed on 2009-04-02  4:45:34
